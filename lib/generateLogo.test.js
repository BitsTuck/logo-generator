...
describe('LogoGen', () => {
  describe('circle', () => {
    it('should create a logo in the shape of a triangle with the background color blue', () => {
      ...
      expect(shape.newShape()).toEqual(`<svg version "1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"> <polygon width="300" height="200" polygon points="150, 18 244, 182 56, 182" fill="pink" /> <text x="150" y="125" font-size="60" text-anchor="middle" fill="orange">wbl</text></svg>`)
    });
  });
});
})